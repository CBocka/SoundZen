package com.cbocka.soundzen.ui.playlists.songslist.adapter
...
class SongsPlaylistAdapter(
    ...
    : ListAdapter<Song, SongsPlaylistAdapter.SongsPlaylistViewHolder>(SONG_COMPARATOR) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SongsPlaylistViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        return SongsPlaylistViewHolder(ItemAudioFileLayoutBinding.inflate(layoutInflater, parent, false))
    }

    override fun onBindViewHolder(holder: SongsPlaylistViewHolder, position: Int) {
        val item = currentList[position]
        holder.bind(item)
    }

    inner class SongsPlaylistViewHolder(private val binding : ItemAudioFileLayoutBinding) : RecyclerView.ViewHolder(binding.root) {
